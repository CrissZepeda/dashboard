...
function Sidebar() {
    ...
    return (
        <>
            <div  className={`fixed lg:static w-[80%] md:w-[40%] lg:w-full bg-white transition-all top-0 ${sidebar ? "-left-0" : "-left-full"} -left-full w-full h-full overflow-y-auto lg:overflow-hidden col-span-1 py-9 flex flex-col gap-4 p-8 shadow-2xl`}>
